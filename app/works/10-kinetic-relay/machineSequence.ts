...
export const COURSE_DEFINITIONS: Record<CourseId, CourseDefinition> = {
  A: {
    ...
    material: "chrome",
    stages: [
      { id: "release", label: "RELEASE", duration: 0.76 },
      { id: "helix", label: "HELIX", duration: 1.28 },
      { id: "rocker", label: "ROCKER", duration: 0.9 },
      { id: "domino", label: "DOMINO", duration: 1.48 },
      { id: "hammer", label: "HAMMER", duration: 1.1 },
      { id: "return", label: "RETURN", duration: 0.92 },
    ],
  },
  B: {
    id: "B",
    name: "CLOCKWORK",
    subtitle: "BRUSHED BRASS / IVORY",
    material: "brass",
    stages: [
      { id: "release", label: "RELEASE", duration: 0.76 },
      { id: "switchback", label: "SWITCHBACK", duration: 1.2 },
      { id: "pendulum", label: "PENDULUM", duration: 1.02 },
      { id: "gear-train", label: "GEAR TRAIN", duration: 1.42 },
      { id: "lift-gate", label: "LIFT GATE", duration: 1.18 },
      { id: "drop", label: "DROP", duration: 0.92 },
      { id: "return", label: "RETURN", duration: 0.86 },
    ],
  },
  C: {
    id: "C",
    ...
    stages: [
      { id: "release", label: "RELEASE", duration: 0.76 },
      { id: "glass-funnel", label: "GLASS FUNNEL", duration: 1.42 },
      { id: "balance", label: "BALANCE", duration: 1.28 },
      { id: "second-marble", label: "SECOND MARBLE", duration: 0.88 },
      { id: "orbit-rail", label: "ORBIT RAIL", duration: 1.18 },
      { id: "turbine", label: "TURBINE", duration: 1.14 },
      { id: "return", label: "RETURN", duration: 0.9 },
    ],
  },
};
