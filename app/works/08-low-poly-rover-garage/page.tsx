...
export const metadata: Metadata = {
  ...
  description: "低ポリ3Dの小型ローバーを組み替え、GarageとTEST COURSEを楽しめるインタラクティブ作品です。",
};
  ...
  <main className={styles.page}>
      <header className={styles.header}>
        ...
        <p className={styles.lead}>
          低ポリの小型ローバーを3カテゴリの部品から組み替え、Garageで眺めてからTEST COURSEへ送り出す作品です。
        </p>
      </header>
      ...
      <section className={styles.infoSection} aria-labelledby="tech-title">
        ...
        <p>
          Three.jsのWebGPURendererと基本Geometryだけで、Front・Cabin・Rearの12モジュールを生成しています。64通りの構成を保存せずに試せて、GarageのOrbit操作と固定カメラのTEST COURSEを切り替えられます。WebGPU APIが使えない環境ではWebGPURendererの互換描画へフォールバックします。外部モデル、テクスチャ、キャラクター、音声は使いません。
        </p>
      </section>
